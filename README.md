...
•	Reconstrucciones de imágenes que demuestran que el modelo ha aprendido a comprimir sin perder información.
•	Un clasificador que detecta tumores con alta precisión.
•	Visualizaciones interpretativas que permiten validar que el modelo mira donde debe mirar.
________________________________________
🧑‍🏫 ¿Cómo explicarlo a tu clase?
Puedes usar analogías como:
•	El autoencoder es como un dibujante que aprende a copiar imágenes simplificándolas.
•	El clasificador es como un médico que, viendo solo lo esencial, decide si hay tumor.
•	Grad-CAM es como una lupa térmica que muestra dónde ha mirado el modelo para decidir.
